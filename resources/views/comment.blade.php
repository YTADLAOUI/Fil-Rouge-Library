    ...
    <div class='d-flex justify-content-center '>
      <div>
        <div class="mt-3" style="width: 18rem;">
          ...
          <h3 class="text-justify"> <b>Titre : {{$livre->titre}}</b></h3>
          <p class="text-justify"><b>Categorie: {{$livre->categories->nom}}</b></p>
          <p class="text-justify"><b>Auteur: {{$livre->auteurs->nom}}</b></p>
    	...
    	<div class="row justify-content-center ">
            <div class="col-md-8 ">   
                <form>
                	...
                	<button type="submit" class="btn btn-normal pull-right me-5">Submit</button>
                    <fieldset>
                        <div class="row">
            ...
            <div class="mt-3">
                <div>
                  @foreach ($livre->commentaires as $item)
